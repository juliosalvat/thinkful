...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func addCharacters() {
        ...
        let lion = Lion(runningSpeedInSeconds: 1.2)
        lion.position = CGPointMake(60, 100)
        addChild(lion)
        ...
        let lion3 = Lion(runningSpeedInSeconds: 0.5)
        lion3.position = CGPointMake(20, 300)
        addChild(lion3)
        
        let lion4 = Lion(runningSpeedInSeconds: 0.3)
        lion4.position = CGPointMake(10, 500)
        addChild(lion4)
    }
